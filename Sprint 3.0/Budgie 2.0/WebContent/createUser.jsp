...
<title>Budgie Create User</title>
<style> 
body {
...
<body>
	...
	<h1 id="main-h"> Please create an account </h1>
	<div id="login-box">
	<form action="signUp" method="post">
		...
		<div class="input-box">
			<label class="login-input">EMAIL ADDRESS</label>
		...
		<div class="input-box"> 
			<label class="login-input">REPEAT PASSWORD</label>
			<input class="w3-input" type="password" name="reppass"> 
		</div>
		<br>
		<div align="right" id="button-box-right"><button class="btn" id="btn-submit" type="submit"><strong>&#10140;</strong></button><br><label>Sign up</label></div>
	</form>
