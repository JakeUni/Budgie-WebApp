	...
	public void doPost(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
		...
		try {
			...
			if ((pass != null) && (user != null) && (email != null)) {
				System.out.print("INSERT INTO user (username, password, email) VALUES ('" + user + "' , '" + pass
						+ "' , '" + email + "'");
				stmt.executeUpdate("INSERT INTO user (username, password, email) VALUES ('" + user + "' , '" + pass
						+ "' , '" + email + "')");
				conn.close();
